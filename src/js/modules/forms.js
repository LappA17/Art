...
const forms = () => {
    const form = document.querySelectorAll('form'),
          ...
          upload = document.querySelectorAll('[name="upload"]');/* добавляем новую переменую что получить доступ
 к инпуту по атрибуту.
...
с двумя элементами */
            ...
            arr[0].length > 6 ? dots = "..." : dots = '.';/* item.files[0].name.split('.') теперь у 
